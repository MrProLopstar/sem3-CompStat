...
import { TbCircleDashedNumber1, TbCircleDashedNumber2, TbCircleDashedNumber3, TbCircleDashedNumber4, TbCircleDashedNumber5, TbCircleDashedNumber6, TbCircleDashedNumber7 } from "react-icons/tb";
const iconStyle = {
  marginTop: 5
};
const icons = [<TbCircleDashedNumber1 style={iconStyle}/>, <TbCircleDashedNumber2 style={iconStyle}/>, <TbCircleDashedNumber3 style={iconStyle}/>, <TbCircleDashedNumber4 style={iconStyle}/>, <TbCircleDashedNumber5 style={iconStyle}/>, <TbCircleDashedNumber6 style={iconStyle}/>, <TbCircleDashedNumber7 style={iconStyle}/>];
